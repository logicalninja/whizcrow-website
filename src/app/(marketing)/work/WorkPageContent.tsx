...
const workFaqs = [
    {
        question: "Are these real results from real clients?",
        answer: "Yes. Every case study on this page represents a real client engagement with verified, measurable outcomes. Some clients are anonymised by request — particularly in sensitive sectors like ORM and financial services — but the numbers are real. We don't inflate results or use projections as actuals."
    },
    {
        question: "How long do your campaigns typically take to deliver results?",
        answer: "It depends on the service. Paid media campaigns can show ROAS improvements within the first 2–4 weeks. SEO and content campaigns compound over 3–12 months. Brand and ORM programmes are typically 6-month+ investments. We set clear timelines and milestones upfront — and we report against them honestly."
    },
    {
        question: "Can you work with businesses in my specific industry?",
        answer: "Probably yes. Our case studies span fintech, banking, e-commerce, luxury retail, healthcare, real estate, hospitality, and government programmes. If you're in a sector we haven't worked in before, we'll tell you directly — and bring in domain research before proposing a strategy."
    },
    {
        question: "Do you have case studies for smaller businesses, not just large brands?",
        answer: "Yes. While some of our most visible results come from larger campaigns, we work with businesses at all stages. Our work for growth-stage companies and startups often produces the most impressive percentage gains — because there's more headroom to move. Reach out and we can share relevant examples for your size and industry."
    },
    {
        question: "How do I know WhizCrow is the right fit for my business?",
        answer: "The best way is a direct conversation. We don't push proposals on people who aren't ready. Book a strategy call and we'll tell you honestly whether we're the right partner, what we'd focus on first, and what results are realistic for your situation. No pitch deck, no pressure."
    }
];
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#F9FAFB] selection:bg-primary selection:text-black">
            ...
            <main className="flex-grow">
                ...
                <ServiceFAQ faqs={workFaqs} title="Questions About Our Work" />
            </main>
