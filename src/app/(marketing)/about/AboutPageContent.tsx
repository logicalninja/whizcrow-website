...
const aboutFaqs = [
    {
        question: "When was WhizCrow founded and where are you based?",
        answer: "WhizCrow was founded in 2017 and is headquartered in Andheri East, Mumbai, India. We work with clients across India and in 15+ countries globally — from early-stage startups to publicly listed companies."
    },
    {
        question: "What makes WhizCrow different from other marketing agencies?",
        answer: "Three things. First, integration — all 10 of our services work together as one system, not as siloed departments. Second, methodology — we operate on a Data → AI → Human framework, meaning every decision is informed by data, scaled by AI, and checked by experienced strategists. Third, accountability — we report on results that matter to your business, not vanity metrics."
    },
    {
        question: "What certifications and accreditations does WhizCrow hold?",
        answer: "We're ISO 27001 (Information Security), ISO 9001 (Quality Management), and ISO 42001:2023 (AI Management) certified. We're also a Google Partner, Shopify Partner, Databox Certified Partner, CMMI Level 5 Maturity, and recognised under MSME, Startup India, and Make in India programmes."
    },
    {
        question: "How large is the WhizCrow team?",
        answer: "We operate a specialist, cross-functional team covering strategy, digital marketing, design, content, PR, technology, and account management. Our model is built for quality over volume — each client gets dedicated specialists, not generalists juggling 40 accounts."
    },
    {
        question: "Do you work with businesses outside India?",
        answer: "Yes. While we're based in Mumbai, we serve clients across the UAE, Southeast Asia, the UK, and the US. For international clients, we handle all timezone coordination and build campaigns tailored to the specific market dynamics of your region."
    },
    {
        question: "How do I start working with WhizCrow?",
        answer: "The easiest way is to contact us directly at hello@whizcrow.com, call +91 83692 19922, or book a strategy call through our website. We start every engagement with a discovery conversation — no commitment required. We'll tell you honestly what we can do for you and what your investment would look like."
    }
];
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#F9FAFB] selection:bg-primary selection:text-black">
            ...
            <main className="flex-grow">
                ...
                <ServiceFAQ faqs={aboutFaqs} title="Questions About WhizCrow" />
